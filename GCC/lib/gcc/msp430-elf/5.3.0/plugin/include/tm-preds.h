/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/srv/net/msp430/jenkins/workspace/msp430-gcc-5-pkg-gnu/gcc.subtree/gcc/config/msp430/msp430.md'.  */
...
extern int msp_volatile_memory_operand (rtx, machine_mode);
extern int msp_general_operand (rtx, machine_mode);
extern int msp_nonimmediate_operand (rtx, machine_mode);
...
extern int msp430_nonsubreg_operand (rtx, machine_mode);
extern int msp430_nonsubreg_or_imm_operand (rtx, machine_mode);
extern int msp430_bitpos (rtx, machine_mode);
